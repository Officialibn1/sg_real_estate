...
<div class="section_container">
	<div class="relative w-full overflow-hidden rounded-3xl">
		<div class="lg:hidden flex flex-col gap-5 bg-[#ecf1f8]">
			...
			<img class="w-full" src="/MobileBanner.svg" alt="Hero Banner" />
		</div>
					...
					>
						...
						<label class="search_input_container flex-[1.5]">
							...
							<div class="flex items-center gap-3">
								<span class="text-sm xl:text-lg">{minRange}</span>
								<input
									class="search_input"
									type="range"
									name="price_range"
									...
									bind:value={maxRange}
								/>
								<span class="flex-1 flex justify-end text-sm xl:text-lg w-24 xl:w-32"
									>{maxRange}</span
								>
							</div>
						</label>
						...
						<button
							type="submit"
							class="py-2 px-3 xl:py-3 xl:px-4 bg-[#1DAEFF] my-auto rounded-xl xl:ml-12 hover:bg-[#1DAEFF]/80 duration-200 ease-in-out group"
							><i
